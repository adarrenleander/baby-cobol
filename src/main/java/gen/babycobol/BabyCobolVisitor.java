...
public interface BabyCobolVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link BabyCobolParser#data_divison}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by {@link BabyCobolParser#picture}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPicture(BabyCobolParser.PictureContext ctx);
	/**
	 * Visit a parse tree produced by {@link BabyCobolParser#like}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLike(BabyCobolParser.LikeContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link BabyCobolParser#using_expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitUsing_expression(BabyCobolParser.Using_expressionContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link BabyCobolParser#next_sentence}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNext_sentence(BabyCobolParser.Next_sentenceContext ctx);
	/**
