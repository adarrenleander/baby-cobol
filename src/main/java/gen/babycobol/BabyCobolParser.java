...
public class BabyCobolParser extends Parser {
	...
	public static final int
		...
		T__31=32, COMPARISON_OPERATOR=33, BOOLEAN_OPERATOR=34, ARITHMETIC_OPERATOR=35, 
		IDENTIFIER=36, VAR=37, INT=38, LITERAL=39, DOT=40, WS=41;
	public static final int
		RULE_program = 0, RULE_identification_division = 1, RULE_data_divison = 2, 
		RULE_procedure_division = 3, RULE_sentence = 4, RULE_procname = 5, RULE_statement = 6, 
		RULE_accept = 7, RULE_add = 8, RULE_subtract = 9, RULE_divide = 10, RULE_multiply = 11, 
		RULE_perform = 12, RULE_display = 13, RULE_stop = 14, RULE_if = 15, RULE_evaluate = 16, 
		RULE_remainder = 17, RULE_giving = 18, RULE_withnoadvancing = 19, RULE_any_expression = 20, 
		RULE_arithmetic_expression = 21, RULE_string_expression = 22, RULE_boolean_expression = 23, 
		RULE_when_block = 24, RULE_atomic = 25, RULE_identifiers = 26;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "identification_division", "data_divison", "procedure_division", 
			"sentence", "procname", "statement", "accept", "add", "subtract", "divide", 
			"multiply", "perform", "display", "stop", "if", "evaluate", "remainder", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'IDENTIFICATION DIVISION.'", "'DATA DIVISION.'", "'PROCEDURE DIVISION.'", 
			"'ACCEPT'", "'ADD'", "'TO'", "'SUBTRACT'", "'FROM'", "'DIVIDE'", "'INTO'", 
			"'MULTIPLY'", "'BY'", "'PERFORM'", "'DISPLAY'", "'STOP'", "'IF'", "'THEN'", 
			"'ELSE'", "'END'", "'EVALUATE'", "'REMAINDER'", "'GIVING'", "'WITH NO ADVANCING'", 
			"'+'", "'TRUE'", "'FALSE'", "'NOT'", "'WHEN'", "'WHEN OTHER'", "'OF'", 
	...
	public final Procedure_divisionContext procedure_division() throws RecognitionException {
		...
		enterRule(_localctx, 6, RULE_procedure_division);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((_la) & ~0x3f) == 0 && ((1L << _la) & 68720650928L) != 0 );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final SentenceContext sentence() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((_la) & ~0x3f) == 0 && ((1L << _la) & 1174192L) != 0 );
			setState(96);
			match(DOT);
			}
			}
	...
	public final AcceptContext accept() throws RecognitionException {
		...
		enterRule(_localctx, 14, RULE_accept);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final PerformContext perform() throws RecognitionException {
		...
		enterRule(_localctx, 24, RULE_perform);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(193);
	...
	public final DisplayContext display() throws RecognitionException {
		...
		enterRule(_localctx, 26, RULE_display);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((_la) & ~0x3f) == 0 && ((1L << _la) & 893353197568L) != 0 );
			setState(203);
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (_la==T__22) {
	...
	public final StopContext stop() throws RecognitionException {
		...
		enterRule(_localctx, 28, RULE_stop);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(205);
	...
	public final EvaluateContext evaluate() throws RecognitionException {
		...
		enterRule(_localctx, 32, RULE_evaluate);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final WithnoadvancingContext withnoadvancing() throws RecognitionException {
		...
		enterRule(_localctx, 38, RULE_withnoadvancing);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(241);
	...
	public final Any_expressionContext any_expression() throws RecognitionException {
		...
		enterRule(_localctx, 40, RULE_any_expression);
		try {
			setState(246);
			_errHandler.sync(this);
	...
	private String_expressionContext string_expression(int _p) throws RecognitionException {
		...
		int _startState = 44;
		enterRecursionRule(_localctx, 44, RULE_string_expression, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	private Boolean_expressionContext boolean_expression(int _p) throws RecognitionException {
		...
		int _startState = 46;
		enterRecursionRule(_localctx, 46, RULE_boolean_expression, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public final When_blockContext when_block() throws RecognitionException {
		...
		enterRule(_localctx, 48, RULE_when_block);
		int _la;
		try {
			setState(302);
			_errHandler.sync(this);
	...
	public final AtomicContext atomic() throws RecognitionException {
		...
		enterRule(_localctx, 50, RULE_atomic);
		try {
			setState(307);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final IdentifiersContext identifiers() throws RecognitionException {
		...
		enterRule(_localctx, 52, RULE_identifiers);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
